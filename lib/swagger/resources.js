...
class resourcesClass {
    ...
    getResourceDefinitions() {
        ...
        for (const resource in this.resources) {
            resourceDefinitions[resource] = this._getResourceDefinition(this.resources[resource])
        }
        resourceDefinitions.error = this._getErrorDefinition()
     ...
     * @returns
     */
    _getResourceDefinition(resourceConfig) {
