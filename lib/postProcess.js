...
postProcess._applySort = require('./postProcessing/sort').action
postProcess._applyFilter = require('./postProcessing/filter').action
postProcess._applyIncludes = require('./postProcessing/include').action
postProcess._applyFields = require('./postProcessing/fields').action
