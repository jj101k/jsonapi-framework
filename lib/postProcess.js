...
class postProcessClass extends RetainsJsonApiPrivate {
    ...
    constructor(jsonApi, privateData) {
        ...
        this.#applyFields = new fieldsClass(this.jsonApi).action
        this.#applyFilter = new filterClass().action
        this.#applyIncludes = new includeClass(this.jsonApi, this.privateData).action
        this.#applySort = new sortClass().action
    }
     ...
     * @returns
     */
    fetchForeignKeys(request, items, schema) {
