...
class responseHelper {
    ...
    #generateDataItem(item, schema) {
        ...
        for(const someProperty of SchemaHelper.for(schema).objectKeys) {
            if(SchemaHelper.for(schema.extract(someProperty)).isRelationship) {
    ...
    #generateLink(item, schemaProperty, linkProperty) {
        ...
        const helper = SchemaHelper.for(schemaProperty)
