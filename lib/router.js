...
class router extends RetainsJsonApiPrivate {
     ...
     * @returns A more structured for of the original request
     */
    #getParams(req) {
    ...
    /**
     * @type {{[verb: string]: {[path: string]: (req: import("express").Request, res: express.Response, extras: Partial<ReturnType<router["#getParams"]>>) => void}}}}
     */
    _routes = { }
     ...
     * @param {(req: import("express").Request, rc: import("../types/jsonApi").ResourceConfig, res: express.Response) => any} callback
     */
