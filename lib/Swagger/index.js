...
class Swagger {
     ...
     *
     * @returns {import("openapi3-ts").OpenAPIObject}
     */
    #getSwaggerBase() {
        ...
        if (this.#apiConfig.urlPrefixAlias) {
            ...
            // Second half is backwards-compat only.

            host = this.#apiConfig.hostname
            if(!host && this.#apiConfig.host) {
                console.warn("'host' argument in API config is deprecated, use 'hostname'")
