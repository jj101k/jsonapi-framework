 ...
 * originalRequest: JsonApiRequest, params?: paramTree}} routeRequest
 * @typedef {{set(): void, status(httpCode: number), end(payload: any):
 * any, httpCode: number | undefined, locals: Record<any, any>}} rerouteResponse
 */
...
class rerouter extends RetainsJsonApiPrivate {
    ...
    async route(newRequest) {
        ...
        const req = new RerouteRequest(newRequest, route, path)
