...
class jsonApi {
    ...
    define(resourceConfig) {
        ...
        const initialise = resourceConfig.handlers.initialise || resourceConfig.handlers.initialize
        ...
        if (this._resources[resourceConfig.resource].handlers.initialise) {
            this._resources[resourceConfig.resource].handlers.initialise(resourceConfig)
        }
    }
