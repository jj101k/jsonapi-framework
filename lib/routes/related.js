...
relatedRoute.register = (privateData, helper, postProcess, jsonApi) => {
    privateData.router.bindRoute({
        ...
        async.waterfall([
            ...
            (newResources, total, callback) => {
                ...
                response = privateData.responseHelper._generateResponse(request, resourceConfig, relatedResources, total)
